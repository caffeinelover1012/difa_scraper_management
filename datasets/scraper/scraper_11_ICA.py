...
ORGANIZATION = "ICA"
DATASET_NAME = "Irish Census of Agriculture (ICA)"
...
class ICA(BaseScraper):
    ...
    def extract_data_attributes(self, soup):
        ...
        try:
            last_updated = soup.find('div', id="dateModified").find('p').get_text().split(":")[-1].strip()
