# Generated by Django 4.1.7 on 2023-04-12 22:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('approver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='approver_mod_requests', to=settings.AUTH_USER_MODEL)),
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='modification_requests', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Collection',
            fields=[
                ...
                ('datasets', models.ManyToManyField(related_name='related_collections', related_query_name='collection', to='datasets.dataset')),
