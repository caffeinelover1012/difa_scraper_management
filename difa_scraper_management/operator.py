...
from datasets.utils import refresh_scraper_mapping
...
def start():
    ...
    scheduler.add_job(refresh_scraper_mapping, "interval", id="refresh_mapping", minutes=10, replace_existing=True)
